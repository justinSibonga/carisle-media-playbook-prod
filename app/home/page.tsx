      ...
      >
        <div className="flex-1 w-full overflow-x-hidden bg-background">
          <div className="max-w-7xl mx-auto px-4 md:px-12 py-8 md:py-16 space-y-16 md:space-y-24">
            <m.div id="tour-hero" variants={fadeIn} className="py-8 md:py-14 mt-16 md:mt-24 flex flex-col items-center text-center">
            ...
            <m.section id="tour-quick-access" variants={fadeIn} className="relative group/carousel">
                  ...
                  <button
                    onClick={() => {
                      document
                        ...
                        ?.scrollBy({ left: -360, behavior: shouldReduceMotion ? "auto" : "smooth" });
                    }}
            ...
            <m.section id="tour-about" variants={fadeIn} className="prose-handbook px-1.5 md:px-0">
            ...
            <m.div variants={fadeIn} className="pt-10 px-1.5 md:px-0">
